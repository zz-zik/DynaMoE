# -*- coding: utf-8 -*-
"""
Copied from M-CD (https://github.com/JayParanjape/M-CD)
Copyright(c) 2024 JayParanjape. All Rights Reserved.
"""
...
from models.encoder import Backbone_VSSM, CrossMambaFusionBlock, ConcatMambaFusionBlock
...
# ckpt: https://github.com/zifuwan/Sigma/tree/main/pretrained/vmamba
...
if __name__ == "__main__":
    ...
    dummy1 = torch.randn(1, 3, 512, 512).cuda()
    dummy2 = torch.randn(1, 3, 512, 512).cuda()
    prof.start_profile()
    dummy_out = model_small(dummy1, dummy2)
    for i in range(len(dummy_out)):
        print(f'{i}th output shape: ', dummy_out[i].shape)
    prof.stop_profile()
